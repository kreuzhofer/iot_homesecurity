...
namespace W10Home.NetCoreDevicePortal.DataAccess
{
    ...
    {
        Task SaveFunctionAsync(string deviceId, string functionId, string functionName, string triggerType, int interval, string queueName, bool enabled, string scriptContent);
